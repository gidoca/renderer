...
{
  QSharedPointer<Material> material(new PhongMaterial(Spectrum(0, 0, 1), Spectrum(0, 0, 1), 64));
  QSharedPointer<Material> material2(new PhongMaterial(Spectrum(0, 1, 1), Spectrum(0, 1, 1), 64));
